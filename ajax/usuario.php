        ...
        case 'verificar':
            ...
            if(isset($fetch))
            {
               ...
               /* in_array(1,$valores) ? setcookie("escritorio", "1", 0, "/") : setcookie("escritorio", "0", 0, "/");
                in_array(2,$valores) ? setcookie("articulo", "1", 0, "/") : setcookie("articulo", "0", 0, "/");
                in_array(3,$valores) ? setcookie("almacen", "1", 0, "/") : setcookie("almacen", "0", 0, "/");
                in_array(4,$valores) ? setcookie("compras", "1", 0, "/") : setcookie("compras", "0", 0, "/");
                in_array(5,$valores) ? setcookie("ventas", "1", 0, "/") : setcookie("ventas", "0", 0, "/");
                in_array(6,$valores) ? setcookie("acceso", "1", 0, "/") : setcookie("acceso", "0", 0, "/");
                in_array(7,$valores) ? setcookie("consultac", "1", 0, "/") : setcookie("consultac", "0", 0, "/");
                in_array(8,$valores) ? setcookie("consultav", "1", 0, "/") : setcookie("consultav", "0", 0, "/");
                in_array(9,$valores) ? setcookie("consultas", "1", 0, "/") : setcookie("consultas", "0", 0, "/");*/
            }
