					...
					<div class="panel-body" style="height: 400px;" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                          <div class="form-group col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            ...
                            <select id="idrodado" name="idrodado" class="form-control selectpicker" data-live-search="true" required>
...
require 'footer.php';
?>
<script type="text/javascript" src="scripts/devolucionrodado.js"></script>
<?php 
}
ob_end_flush();
?>
