...
<!--Contenido-->
              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Entrega Rodados<button class="btn btn-success" id="btnagregar"  style="margin-left: 20px" onclick="mostrarform(true,true)"><i class="fa fa-plus-circle"></i> Agregar</button></h1>
					...
					<div class="panel-body" style="height: auto;" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                          <div class="form-group col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            ...
                            <select title="<b>Seleccione un Rodado</b>" id="idrodado" name="idrodado" class="form-control selectpicker" data-live-search="true" required>
                            </select>
                          </div>
                          <div class="form-group col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <label>Fecha(*):</label>
                          ...
                          <div class="form-group col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            ...
                            <select name="tipo_comprobante" id="tipo_comprobante" class="form-control selectpicker" required="">
                               <option value="Orden de Salida Rodado">Orden Salida Rodado</option>
  ...
  <!-- ***********************MODAL ARTICULOS******************************-->
  <div class="modal fade" id="myModal" tabindex="-1" role="document" aria-labelledby="myModalLabel" aria-hidden="true" onclick="cierreModalArticulos();">
    <div class="modal-dialog" style="width: 80% !important;">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true" onclick="cierreModalArticulos();">&times;</button>
...
<script type="text/javascript" src="scripts/ventarodado.js"></script>
<script>
